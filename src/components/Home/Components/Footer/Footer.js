...
const Footer = () => {
  ...
  return (
    <div style={{background: 'black', width: '100vw', display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column'}}>
        
        {/* eslint-disable-next-line */}
        <a target="_blank" className='maps' href='https://maps.app.goo.gl/BzmQLBfq2Sb78nxu9'>
