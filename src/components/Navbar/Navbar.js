...
import thhwhite from '../MediaAssets/Homepage/LogoWhite.png';
import './Navbar.scss';
// import $ from "jquery"
  ...
  return (
    <div style={{zIndex: '1000000000000000000001'}}>
      ...
      <NavLink className="nav-link" to="/">
        <img alt='thhlogo' style={{width: '50px', top: '20px', left: '20px', zIndex: '1000000000', position: 'fixed'}} src={thhwhite}/>
      </NavLink>
