  ...
  return (
    <div className="tc-content-container">
      ...
      <div className="tc-desc-section">
        <p>
          Welcome to Al Nakheel Advertising LLC! These terms and conditions outline the
          rules and regulations for the use of Al Nakheel Advertising LLC' Website,
          located at https://alnakheeladvertisingllc.vercel.app . By accessing this website, we
          assume you accept these terms and conditions. Do not continue to use
          Al Nakheel Advertising LLC if you do not agree to take all of the terms and
          conditions stated on this page. <br /> <br />
          The following terminology applies to these Terms and Conditions,
          Privacy Statement, and Disclaimer Notice and all Agreements: "Client,"
          "You," and "Your" refer to you, the person logging onto this website
          and compliant with the Company’s terms and conditions...
        </p>
        <h3>Cookies</h3>
        <p>
          We employ the use of cookies. By accessing Al Nakheel Advertising LLC, you
          agree to use cookies in agreement with Al Nakheel Advertising LLC' Privacy
          Policy. Most interactive websites use cookies to let us retrieve the
          user’s details for each visit...
        </p>
        <h3>License</h3>
        <p>
          Unless otherwise stated, Al Nakheel Advertising LLC and/or its licensors own
          the intellectual property rights for all material on REX Medical
          Events. All intellectual property rights are reserved...
          <br />
          You must not:
          <ul>
            <li>Republish material from Al Nakheel Advertising LLC</li>
            <li>Sell, rent, or sub-license material from Al Nakheel Advertising LLC</li>
            <li>
              Reproduce, duplicate, or copy material from Al Nakheel Advertising LLC
            </li>
            <li>Redistribute content from Al Nakheel Advertising LLC</li>
          </ul>
          Parts of this website offer an opportunity for users to post and
          exchange opinions and information in certain areas of the website. REX
          Medical Events does not filter, edit, publish, or review Comments
          prior to their presence on the website. Comments do not reflect the
          views and opinions of Al Nakheel Advertising LLC, its agents, and/or
          affiliates. Comments reflect the views and opinions of the person who
          posts their views and opinions. To the extent permitted by applicable
          laws, Al Nakheel Advertising LLC shall not be liable for the Comments or for
          ...
          this website.
          <br />
          Al Nakheel Advertising LLC reserves the right to monitor all Comments and to
          remove any Comments which can be considered inappropriate, offensive,
          or causes a breach of these Terms and Conditions.
          <br />
          ...
          You hereby grant Al Nakheel Advertising LLC a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Al Nakheel Advertising LLC; and (d)
          the link is in the context of general resource information. <br />
          ...
          sending an e-mail to Al Nakheel Advertising LLC. Please include your name,
          ...
          No use of Al Nakheel Advertising LLC’ logo or other artwork will be allowed
